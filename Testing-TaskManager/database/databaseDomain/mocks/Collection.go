...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (databasedomain.Cursor, error) {
	...
	var r0 databasedomain.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) (databasedomain.Cursor, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) databasedomain.Cursor); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(databasedomain.Cursor)
		}
	}
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) databasedomain.SingleResult {
	ret := _m.Called(_a0, _a1)
	...
	var r0 databasedomain.SingleResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) databasedomain.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(databasedomain.SingleResult)
		}
	}
...
func (_m *Collection) Indexes() databasedomain.IndexView {
	ret := _m.Called()
	...
	var r0 databasedomain.IndexView
	if rf, ok := ret.Get(0).(func() databasedomain.IndexView); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(databasedomain.IndexView)
		}
	}
